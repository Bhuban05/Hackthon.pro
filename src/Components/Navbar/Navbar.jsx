        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-10">
            ...
            <div className="flex flex-col items-center text-center max-w-sm shadow-2xl hover:bg-gray-50">
              <img
                className="w-17 h-17 rounded-md mb-4 object-cover"
                src="https://media.istockphoto.com/id/1357068122/vector/isometric-money-wallet-with-security-system.jpg?s=612x612&w=0&k=20&c=2DllXeQ7LBr16BTKhInBNb4pavDQM09yF5USphv9hpA=" // (same or different base64 image)
                alt="Image 2"
              />
              <p className="text-gray-700"> Your safety is paramount. Our app provides timely alerts about potential issues, keeping you informed and safe throughout your journey.</p>
            </div>
          </div>
