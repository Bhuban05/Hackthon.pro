          ...
          <div className="p-8">
            <form className="space-y-5">
              ...
              <div className="text-center text-sm text-gray-600">
                ...
                <a href="#" className="ml-1 font-medium text-blue-600 hover:underline">Sign in</a>
              </div>
            </form>
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 grid grid-cols-3 gap-3">
                ...
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                    <path fillRule="evenodd" d="M10 0C4.477 0 0 4.477 0 10c0 5.523 4.477 10 10 10 5.523 0 10-4.477 10-10 0-5.523-4.477-10-10-10zm6.561 9.525c-1.133 0-2.062-.966-2.062-2.065 0-1.129.929-2.063 2.062-2.063 1.128 0 2.06.934 2.06 2.063 0 1.099-.932 2.065-2.06 2.065zm-5.327 5.503c-.471 0-.906-.161-1.25-.439-.344.278-.779.439-1.25.439-1.217 0-2.219-.99-2.219-2.206 0-.389.107-.753.293-1.065H5.806v-3.19c0-.712.578-1.29 1.29-1.29h2.588v-1.29H10v1.29h1.935v1.29H10v1.935h1.935v1.29H10v1.935h1.935c.712 0 1.29.578 1.29 1.29v1.935h-1.29c-.389 0-.753.107-1.065.293.161.344.258.779.258 1.25 0 1.217-.99 2.219-2.206 2.219z" clipRule="evenodd" />
                  </svg>
                </button>
              </div>
            </div>
